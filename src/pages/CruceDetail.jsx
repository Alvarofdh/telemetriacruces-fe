...
const crucesDetallados = {
  ...
  3: {
    ...
    instalacion: '2023-01-10',
    ultimoMantenimiento: '2024-01-05',
    proximoMantenimiento: '2024-02-05',
    historicoTrafico: [
      { fecha: '2024-01-15', trenes: 9, velocidadMax: 65 },
      { fecha: '2024-01-14', trenes: 11, velocidadMax: 60 },
      { fecha: '2024-01-13', trenes: 7, velocidadMax: 58 },
      { fecha: '2024-01-12', trenes: 13, velocidadMax: 62 },
      { fecha: '2024-01-11', trenes: 8, velocidadMax: 57 }
    ],
    sensores: [
      { id: 1, tipo: 'Proximidad', estado: 'ACTIVO', ubicacion: 'Norte' },
      { id: 2, tipo: 'Velocidad', estado: 'ACTIVO', ubicacion: 'Centro' },
      { id: 3, tipo: 'Peso', estado: 'INACTIVO', ubicacion: 'Sur' },
      { id: 4, tipo: 'Barrera', estado: 'ACTIVO', ubicacion: 'Cruce' }
    ],
    configuracion: {
      tiempoAlerta: 35,
    ...
    contacto: {
      ...
      email: 'carlos.rodriguez@ferrocarriles.cl'
    }
  }
  // Agregamos más cruces aquí si es necesario
};
