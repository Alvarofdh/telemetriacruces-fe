 ...
 * Puede ver y gestionar cruces, alertas, telemetría
 * NO puede gestionar usuarios ni acceder a configuración del sistema
 */
export function MaintenancePanel() {
	...
	// Menú limitado para mantenimiento (sin usuarios, logs, config)
	const menuItems = [
	...
	return (
		<BasePanelLayout
			...
			subtitle="Gestión de Cruces y Alertas"
			menuItems={menuItems}
			activeTab={activeTab}
